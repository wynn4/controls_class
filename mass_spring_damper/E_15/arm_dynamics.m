function [sys,x0,str,ts,simStateCompliance] = arm_dynamics(t,x,u,flag,AP)
switch flag,
...
function sys=mdlDerivatives(t,x,u,AP)
  ...
  thetaddot = (3/AP.m/AP.ell^2)*(tau - AP.b*thetadot - AP.m*AP.g*AP.ell/2*cos(theta)); 
