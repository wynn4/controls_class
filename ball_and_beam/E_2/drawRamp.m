...
function handle = drawBall_(theta, z, r, w, handle)
  ...
  pts = [...
      ...
      r*cos(7*pi/6), r*sin(7*pi/6)+(r+(1/16));...
      r*cos(8*pi/6), r*sin(8*pi/6)+(r+(1/16));...
      r*cos(9*pi/6), r*sin(9*pi/6)+(r+(1/16));...
      r*cos(10*pi/6), r*sin(10*pi/6)+(r+(1/16));...
      r*cos(11*pi/6), r*sin(11*pi/6)+(r+(1/16));...
      r*cos(0), r*sin(0)+(r+(1/16));...
